  ...
  <div class="container-fluid" style="font-size:17px;">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Shop by Category<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Keypad Mobile</a></li>
          <li><a href="#">Smart Mobile</a></li>
   ...
   <div>
    ...
    <li class="dropdown" style="margin-top:-50px;"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Welcome : ${sessionScope.user1.firstName} ${sessionScope.user1.lastName}<span class="caret"></span></a>
      ...
      <li style="margin-top:-50px; margin-left:200px; margin-right:-100px;"><a href="HomePage.jsp"><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
    </ul>
    </div>
  </div>
</nav>
